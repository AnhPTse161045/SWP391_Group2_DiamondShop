      ...
      <div>
        ...
        <header className="bg-black white-80 tc pv4 avenir header-content">
          ...
          <nav className="bt bb tc mw7 center mt4 nav-links " >
            <a
              className="f6 f5-l link bg-animate white-80 hover-bg-lightest-blue dib pa3 ph4-l"
              href="/"
            >
              Home
            </a>
            <a
              className="f6 f5-l link bg-animate white-80 hover-bg-light-green dib pa3 ph4-l"
              href="/shop"
            >
              Shop
            </a>
            <a
              className="f6 f5-l link bg-animate white-80 hover-bg-light-blue dib pa3 ph4-l"
              href="/knowledge"
            >
              Knowledge
            </a>
            <a
              className="f6 f5-l link bg-animate white-80 hover-bg-light-pink dib pa3 ph4-l"
              href="/about"
            >
              About
            </a>
            ...
            <a
              ...
              href="/search"
            >
              <MDBIcon fas icon="search" className="white-icon" /> {/* Search icon */}
            </a>
          </nav>
        </header>
